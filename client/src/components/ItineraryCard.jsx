...
export default function ItineraryCard(props) {
  ...
  return (
    <>
      {posts ? (
        <div className="relative mt-2 pt-20 pb-10 px-4 sm:px-6 lg:pt-10 lg:pb-28 lg:px-8">
          <div className="relative max-w-4xl  mx-auto">
            <div className="mt-1 pb-10 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none overflow-x-auto">
              {posts?.map((post) => (
                <div
                  key={post.id}
